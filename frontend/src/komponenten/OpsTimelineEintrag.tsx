...
const AUSLOSER_OPTIONEN = [
  ...
  // T-0455: Gardena-Cloud-Zeitplan. Echtes Wasser, aber kein Engine-Lauf --
  // vorher landeten diese Laeufe je nach Ingest-Pfad unter Manuell oder
  // Automatik und waren nicht auseinanderzuhalten.
  { wert: 'zeitplan', label: 'Gardena-Zeitplan' },
  // T-0453: echter Feuchte-Sprung, aber Wasser aus einer Nachbar-Zone
  // (Cross-Spray). Zaehlt nicht als Wasser dieses Kanals.
  { wert: 'fremdwasser', label: 'Fremdwasser (Nachbar)' },
...
function metaText(meta: Record<string, string | number | boolean | null>): string[] {
  const labelMap: Record<string, string> = {
    ...
    behoben_um: 'Behoben',
    anzahl: 'Anzahl',
    // T-0453: bei Fremdwasser die abgeleitete Cross-Spray-Quelle zeigen.
    quell_zone: 'Wasser aus',
  }
