...
def client_mit_status(tmp_path):
    ...
    (backup_dir / "bewaesserung_2026-05-25.db").write_bytes(b"x")
    (backup_dir / "bewaesserung_2026-05-24.db").write_bytes(b"y")
...
def test_betriebsstatus_backup_findet_snapshots(client_mit_status):
    ...
    assert body["backup"]["letzter_snapshot"] is not None
