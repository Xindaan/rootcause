...
def test_ventil_severity_ordnet_ausloser_ein():
    ...
    erwartung = {
        ...
        # T-0455: Gardena-Cloud-Zeitplan ist ein realer, gewollter Lauf
        # (Fallback wenn der Rechner aus ist) -> Routine wie automatik.
        Ausloser.ZEITPLAN: "ROUTINE",
        # T-0453: Cross-Spray vom Nachbar-Regner, vom User bereits
        # klassifiziert = erklaert -> nichts zu tun.
        Ausloser.FREMDWASSER: "ROUTINE",
