    ...
    *,
    ...
    try:
        ...
        if client is not None:
            ...
            # T-0508: NICHT `stunden[:n]` -- die Liste beginnt bei heute
            # 00:00, das waeren also die ersten Nachtstunden statt der
            # naechsten N. Der Funktionsname sagt "Zukunft"; bis 05.08.2026
            # lieferte sie die Vergangenheit in eine Vorwaerts-Simulation.
            st_liste = vorhersage.zukunftsstunden(stunden, jetzt)
            return (
