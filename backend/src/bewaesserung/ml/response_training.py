...
STANDARD_PARAMS: dict = {
    ...
    "lambda_l2": 1.0,
    "seed": 42,
    # T-0518: siehe die ausfuehrliche Begruendung in `ml/training.py`. Dort
    # gemessen (13 Cluster, 58.459 Zeilen): ein Thread ist 68 % schneller als
    # zehn, weil der Fork-Join-Overhead die kurzen parallelen Regionen
    # ueberwiegt.
    #
    # **Hier uebernommen, nicht eigens gemessen** -- und das ist der
    # konservative Weg, nicht der bequeme: die Response-Datensaetze sind pro
    # Zone ZWEISTELLIG bis niedrig dreistellig, also noch weiter im
    # Mini-Datensatz-Bereich als der kleinste Feuchte-Cluster (1.439 Zeilen,
    # dort Faktor 4,1 zugunsten eines Threads). Der Effekt kann hier also nur
    # groesser sein. Wer es genau wissen will:
    # `docs/analyse/t0518_num_threads/benchmark.py` als Vorlage nehmen.
    "num_threads": 1,
}
