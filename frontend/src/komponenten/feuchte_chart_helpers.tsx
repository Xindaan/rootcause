...
// T-0573: die reine Segment-Logik liegt in einem eigenen Modul OHNE
// React-/Recharts-Import -- nur so laesst sie sich in node ausfuehren
// und ihr Verhalten pruefen (`frontend/tests/pruefe_chart_segmente.mjs`).
// Re-Export, damit alle bisherigen Importpfade unveraendert gelten.
export {
  baueChartDatenProSensor,
  segmentDatenKey,
  findeKalibrierFensterFuer,
  baueSegmentLinien,
  istKalibrierFenster,
} from './feuchte_chart_segmente'
import { istKalibrierFenster } from './feuchte_chart_segmente'
