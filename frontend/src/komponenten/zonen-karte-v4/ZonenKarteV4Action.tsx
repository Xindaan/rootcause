...
interface Inhalt {
  ...
  quelle?: 'ML' | 'Heuristik' | 'Manuell' | null
...
function dauerQuelle(e: GiessEmpfehlung | null): 'ML' | 'Heuristik' | null {
  if (!e) return null
...
function dauerDetailZeile(e: GiessEmpfehlung | null): ReactNode {
  ...
  if (ml == null && heuristik == null) return null
  ...
  const hauptMin = haupt === 'ML' && ml != null
    ? Math.round(ml / 60)
    : heuristik != null
