...
export interface GiessLauf {
  ...
  ausloser: string              // 'automatik' | 'manuell' | 'ignoriert' | ...
  zaehlt: boolean               // false = ignoriert/cross-spray/aquabloom
  laeuft_noch: boolean
...
export type AusloeserPatch = 'automatik' | 'manuell' | 'unbekannt' | 'watchdog' | 'notfall_stopp'
